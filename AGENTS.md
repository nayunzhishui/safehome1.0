...
当前阶段：MVP 1.0 已完成，MVP 1.1 家长端主闭环和网站后台第一版已完成；6.3 问题整改清单 P0-01 至 P0-08 已完成，下一步继续 P1 试用前必要能力。
...
1. 先阅读并遵守 `docs/项目进度统一口径.md` 和 `docs/6.3日问题清单解决逐步开发书.md`。
2. 6.3 清单下一步继续 P1 阶段，优先完成命名修正、内容校验和内容元数据补齐。
3. 学生画像仍需执行 `docs/1.2逐步开发任务清单.md` 的 1.2-5 试点前人工验收。
