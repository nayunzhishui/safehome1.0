...
SCHEMA_SQL = [
    ...
    CREATE TABLE IF NOT EXISTS research_execution_manifests (
        ...
        execution_image_ref TEXT NOT NULL,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS therapeutic_assessment_quality_reviews (
        id TEXT PRIMARY KEY,
        case_id TEXT NOT NULL,
        feedback_id TEXT NOT NULL,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS therapeutic_assessment_quality_incidents (
        id TEXT PRIMARY KEY,
        case_id TEXT NOT NULL,
        feedback_id TEXT,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS therapeutic_assessment_quality_events (
        id TEXT PRIMARY KEY,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS therapeutic_assessment_launch_screenings (
        id TEXT PRIMARY KEY,
        case_id TEXT NOT NULL,
        participant_user_id TEXT NOT NULL,
        ...
        concern_scope TEXT NOT NULL,
        excluded_signals_json TEXT NOT NULL DEFAULT '[]',
        acknowledged_notices_json TEXT NOT NULL DEFAULT '[]',
        decision TEXT NOT NULL,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS therapeutic_assessment_ai_assist_candidates (
        id TEXT PRIMARY KEY,
        case_id TEXT NOT NULL,
        task_type TEXT NOT NULL,
        ...
        five_gate_results_json TEXT NOT NULL DEFAULT '{}',
        provider_mode TEXT NOT NULL,
        status TEXT NOT NULL DEFAULT 'pending_human_decision',
...
INDEX_SQL = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_research_artifact_manifest ON research_analysis_artifacts(execution_manifest_id)",
    "CREATE INDEX IF NOT EXISTS idx_research_analysis_event_job ON research_analysis_events(job_id, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_research_source_hash ON research_source_objects(server_hash, status)",
    "CREATE INDEX IF NOT EXISTS idx_research_manifest_job_status ON research_execution_manifests(job_id, status, created_at)",
    "CREATE INDEX IF NOT EXISTS idx_research_manifest_reproducibility ON research_execution_manifests(reproducibility_key, status, created_at)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_therapeutic_quality_reviews_status_due ON therapeutic_assessment_quality_reviews(status, due_at)",
    ...
    "CREATE INDEX IF NOT EXISTS idx_ta_ai_assist_case_status ON therapeutic_assessment_ai_assist_candidates(case_id, status, updated_at)",
