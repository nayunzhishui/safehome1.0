"""Task 37 A06 monitoring schema audit and non-destructive rollback plan."""
...
TABLES = ("offline_model_monitor_runs", "offline_model_runtime_controls")
...
def rollback_plan() -> dict:
    return {
        ...
        "steps": [
            "执行full_disable停止情感模型运行",
            "保留监测运行和运行控制版本作为审计证据",
            "情绪记录、规则反馈与训练卡继续使用既有非模型链路",
        ],
        "core_chain_dependency": False,
