"""Additive Task38-F13 low-risk adult launch-scope migration."""
...
TABLES = {"therapeutic_assessment_launch_screenings"}
CONFIRMATION = "APPLY_TASK38_F13_ADULT_LAUNCH_SCOPE"
