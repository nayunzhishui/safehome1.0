"""Additive Task38-F05 dynamic consent migration."""
...
TABLES = {"therapeutic_assessment_data_items", "therapeutic_assessment_data_consents"}
CONFIRMATION = "APPLY_TASK38_F05_DYNAMIC_CONSENT"
def inspect():
