"""Additive Task38-F16 therapeutic-assessment AI candidate migration."""
...
TABLES = {"therapeutic_assessment_ai_assist_candidates"}
CONFIRMATION = "APPLY_TASK38_F16_AI_ASSIST_CANDIDATES"
