"""Additive migration and verification for Task37-C02 provider evidence."""
...
TABLE = "ai_provider_contract_evidence"
REQUIRED_COLUMNS = {
    "provider_id",
    "evidence_type",
    "artifact_ref",
...
CONFIRMATION = "APPLY_TASK37_C02_PROVIDER_EVIDENCE"
