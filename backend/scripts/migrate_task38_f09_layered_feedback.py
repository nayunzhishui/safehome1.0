"""Additive Task38-F09 layered-feedback migration."""
...
CONFIRMATION = "APPLY_TASK38_F09_LAYERED_FEEDBACK"
...
def inspect() -> dict:
    with get_connection() as conn:
        ...
        columns = {
            row["name"] for row in list_database_columns(conn, "therapeutic_assessment_feedback_versions")
        }
