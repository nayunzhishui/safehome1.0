"""Additive Task38-F07 responsibility-chain migration."""
...
CONFIRMATION = "APPLY_TASK38_F07_SAFETY_CHAIN"
...
def main() -> int:
    ...
    is_production = str(Config.APP_ENV).lower() == "production"
    if (
        is_production
        and args.action == "apply"
        and (not args.allow_production or args.confirmation != CONFIRMATION)
    ):
    ...
    if args.action == "apply":
        ...
        result = {
            "action": "apply",
            **inspect(),
            "production_mutation": is_production,
        }
