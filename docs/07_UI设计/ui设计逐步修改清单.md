...
每轮结束都在 `docs/00_当前事实基准/开发日志.md` 增加：
...
每轮结束都在 `docs/00_当前事实基准/当前进度交接.md` 增加：
...
每轮结束都在 `docs/00_当前事实基准/开发说明.md` 增加：
...
请先阅读 docs/07_UI设计/小程序设计系统.md 和 docs/07_UI设计/ui设计逐步修改清单.md。
...
页面结构按 docs/07_UI设计/ui设计逐步修改清单.md 第 5 节执行：
...
任务结束后更新 docs/00_当前事实基准/开发日志.md、docs/00_当前事实基准/当前进度交接.md、docs/00_当前事实基准/开发说明.md。
```
...
请先阅读：
1. AGENTS.md
2. docs/07_UI设计/小程序设计系统.md
3. docs/07_UI设计/ui设计逐步修改清单.md
4. docs/00_当前事实基准/当前进度交接.md
5. docs/00_当前事实基准/开发日志.md
...
请阅读 docs/07_UI设计/小程序设计系统.md 和 docs/07_UI设计/ui设计逐步修改清单.md。
...
完成后运行验证命令，并更新 docs/00_当前事实基准/开发日志.md、docs/00_当前事实基准/当前进度交接.md、docs/00_当前事实基准/开发说明.md。
```
