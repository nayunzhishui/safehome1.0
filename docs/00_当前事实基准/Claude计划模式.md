...
| T36-F13 在线分析任务 | 计划未开始 | 异步任务、快照、版本、租约、死信、删除 | 失败/取消/恢复/撤回/停用 | 数据用途与伦理 |
| T36-F14 情感与网络分析 | 计划未开始 | 聚合情感、语义网络、家庭拓扑研究者视图 | 小样本、未知率、版本、性能 | T35数据/模型门禁 |
| T36-F15 AI自由问答 | 计划未开始 | 研究者沙盒、批准知识、引用、拒答、供应商适配 | 注入/敏感/超时/预算/删除 | AI、伦理、安全批准 |
| T36-F16 治疗性评估 | 计划未开始 | 评估问题、共同核对、反馈版本、一小步和随访 | 同意/撤回/不同意/风险/人工确认 | TA资质、督导、D01—D26 |
| T36-F17 安全可靠性 | 计划未开始 | 幂等、限速、审计、死信、泄漏扫描、删除 | 故障注入与恢复 | 安全/隐私负责人 |
| T36-F18 迁移回滚 | 计划未开始 | SQLite/MySQL、备份恢复、非破坏回滚 | 空/旧/重复/部分失败/MySQL5.7 | 生产迁移恢复批准 |
| T36-F19 全量验收 | 计划未开始 | 后端/shared/Web/小程序/云/故障/文档 | 专项+全量全部通过 | 人工/伦理/真机/云/生产签字 |
