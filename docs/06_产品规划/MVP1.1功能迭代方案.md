...
本方案最初用于 MVP 1.1 规划。当前已补充实际完成情况，用于区分“已完成第一版”和“后置能力”。最新统一进度以 `docs/00_当前事实基准/项目进度统一口径.md` 为准。

## 0A. 2026-06-01 统一进度补充

当前 MVP 1.1 家长端主闭环与网站后台第一版已经完成。本文后续章节中涉及“规划、建议、新增”的内容，若与本节冲突，以本节和 `docs/00_当前事实基准/项目进度统一口径.md` 为准。
...
如果继续开发，不建议再从 MVP 1.1 常规页面开始，而应优先根据 `docs/01_当前执行入口/1.2逐步开发任务清单.md` 执行学生画像 P0-4。
