...
| DELETE | `/api/research/analysis/artifacts/<artifact_id>` | role:researcher,supervisor,admin | assigned_participants_for_researcher_full_for_supervisor_admin | — | — | active |
...
| POST | `/api/research/analysis/jobs/<job_id>/claim` | role:researcher,supervisor,admin | assigned_participants_for_researcher_full_for_supervisor_admin | — | — | active |
| POST | `/api/research/analysis/jobs/<job_id>/complete` | role:researcher,supervisor,admin | assigned_participants_for_researcher_full_for_supervisor_admin | — | — | active |
| POST | `/api/research/analysis/jobs/<job_id>/fail` | role:researcher,supervisor,admin | assigned_participants_for_researcher_full_for_supervisor_admin | — | — | active |
| POST | `/api/research/analysis/jobs/<job_id>/recover` | role:researcher,supervisor,admin | assigned_participants_for_researcher_full_for_supervisor_admin | — | — | active |
| POST | `/api/research/analysis/jobs/<job_id>/suspend` | role:researcher,supervisor,admin | assigned_participants_for_researcher_full_for_supervisor_admin | — | — | active |
