...
| PATCH | `/api/therapeutic-assessment/cases/<case_id>/child-safeguards/decision` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| PATCH | `/api/therapeutic-assessment/cases/<case_id>/child-safeguards/gates` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
...
| GET | `/api/therapeutic-assessment/child-safeguards` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
...
| GET | `/api/therapeutic-assessment/method-library` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| GET | `/api/therapeutic-assessment/method-library/<item_id>` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| GET | `/api/therapeutic-assessment/multi-party-safeguards` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| GET | `/api/therapeutic-assessment/pilot-evidence/<stage_id>` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
...
| GET | `/api/therapeutic-assessment/production-gate` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| POST | `/api/therapeutic-assessment/production-gate/evaluate` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| GET | `/api/therapeutic-assessment/production-gate/evidence` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| POST | `/api/therapeutic-assessment/production-gate/evidence` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| POST | `/api/therapeutic-assessment/production-gate/evidence/<evidence_id>/verify` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
...
| POST | `/api/therapeutic-assessment/stop-recovery/evidence/<evidence_id>/verify` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| POST | `/api/therapeutic-assessment/stop-recovery/incidents` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| POST | `/api/therapeutic-assessment/stop-recovery/incidents/<incident_id>/evidence` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| POST | `/api/therapeutic-assessment/stop-recovery/incidents/<incident_id>/restore` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
| GET | `/api/therapeutic-assessment/stop-recovery/status` | role:parent,student,researcher,supervisor,admin | role_scoped | — | — | active |
